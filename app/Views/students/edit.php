        ...
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card shadow">
                ...
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                              <?= lang('App.editStudent') ?>
                                </h4>
                </div>

                <div class="card-body">

                <form action="<?= site_url('students/update/'.$student['StudentID']) ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                              <label class="form-label"><?= lang('App.rollNo') ?> 
                             </label>
...
<option value="Section A"
    <?= old('Section', $student['Section']) == 'Section A' ? 'selected' : '' ?>>
    <?= lang('App.sectionA') ?>
</option>

<option value="Section B"
    <?= old('Section', $student['Section']) == 'Section B' ? 'selected' : '' ?>>
    <?= lang('App.sectionB') ?>
</option>

<option value="Section C"
    <?= old('Section', $student['Section']) == 'Section C' ? 'selected' : '' ?>>
    <?= lang('App.sectionC') ?>
</option>
...
<label class="form-label"><?= lang('App.address') ?></label>
    ...
    name="Address"
    rows="3"
    class="form-control <?= validation_show_error('Address') ? 'is-invalid' : '' ?>"><?= old('Address', $student['Address']) ?></textarea>
...
<input
    type="file"
    name="Photo"
    class="form-control <?= $validation->getError('Photo') ? 'is-invalid' : '' ?>">
